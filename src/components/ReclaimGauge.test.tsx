...
const RULES: RuleSummary[] = [
  { id: "windows.temp", category: "System", label: "Temporary files", risk: "low", kind: "files", default_checked: true, unavailable_reason: null },
  { id: "windows.recycle-bin", category: "System", label: "Recycle Bin", risk: "low", kind: "recycle-bin", default_checked: true, unavailable_reason: null },
  { id: "edge.cache", category: "Browsers", label: "Microsoft Edge cache", risk: "low", kind: "files", default_checked: true, unavailable_reason: null },
  { id: "chrome.cache", category: "Browsers", label: "Google Chrome cache", risk: "low", kind: "files", default_checked: true, unavailable_reason: null },
];
